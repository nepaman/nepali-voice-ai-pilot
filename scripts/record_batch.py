...
EXTRA_SENTENCES_2 = [
    ...
    ("टमाटर", "tamaatar"),
    ("खुर्सानी", "khursaani"),
    ("हरियो सागसब्जी", "hariyo saagsabji"),

    # Fruits - never recorded
    ("स्याउ", "syaau"),
    ("केरा", "keraa"),
    ("आँप", "aaamp"),
    ("अनार", "anaar"),
    ...
    # Weather - never recorded
    ("हुरी चल्यो", "huri chalyo"),
    ("आँधी आयो", "aandhi aayo"),
    ("कुहिरो छ", "kuhiro chha"),
    ("असिना पर्यो", "asina paryo"),
    ("भूकम्प गयो", "bhukamp gayo"),
    ("बाढी आयो", "baadhi aayo"),
    ("खडेरी छ", "khaderi chha"),
    ("मौसम परिवर्तन भयो", "mausam paribhartan bhayo"),
    ("जाडो मौसम सुरु भयो", "jaado mausam suru bhayo"),
    ("गर्मी धेरै छ", "garmi dherai chha"),

    # Health - never recorded
    ("रक्तचाप बढेको छ", "raktachaap badheko chha"),
    ("मधुमेह छ", "madhumeh chha"),
    ("एलर्जी छ", "allergy chha"),
    ("चस्मा लगाउँछु", "chasma lagaunchhu"),
    ("औषधि खाइसकेँ", "aushadhi khaaisaken"),
    ("अस्पताल भर्ना भएँ", "aspatal bharna bhaen"),
    ("अपरेशन गरियो", "operation gariyo"),
    ("खोप लगाइयो", "khop lagaiyo"),
    ("रगत जाँच गरियो", "ragat jaanch gariyo"),
    ("एक्स-रे गरियो", "x-ray gariyo"),

    # Education - never recorded
    ("विश्वविद्यालय", "bishwavidyaalay"),
    ("कलेज", "college"),
    ("प्राथमिक विद्यालय", "praathamik vidyaalay"),
    ("माध्यमिक विद्यालय", "maadhyamik vidyaalay"),
    ("छात्रवृत्ति पाएँ", "chhaatrabritti paaen"),
    ("परीक्षा पास गरेँ", "pareeksha paas garen"),
    ("डिग्री लिएँ", "degree lien"),
    ("पाठ्यक्रम", "paathyakram"),
    ("गृहकार्य गरेँ", "grihakaarya garen"),
    ("शिक्षा महत्त्वपूर्ण छ", "shikshaa mahattwapurna chha"),

    # Sports - never recorded
    ("क्रिकेट खेल्छु", "cricket khelchhu"),
    ("फुटबल खेल्छु", "football khelchhu"),
    ("भलिबल खेल्छु", "volleyball khelchhu"),
    ("ब्याडमिन्टन खेल्छु", "badminton khelchhu"),
    ("पौडी खेल्छु", "pauddhi khelchhu"),
    ("दौडिन्छु", "daudddinchhu"),
    ("योगा गर्छु", "yoga garchhu"),
    ("जिम जान्छु", "gym jaanchhu"),
    ("साइकल चलाउँछु", "cycle chalaunchhu"),
    ("पहाड चढ्छु", "pahaad chadhchhu"),

    # Professions - never recorded
    ("डाक्टर", "daaktor"),
    ("नर्स", "nurse"),
    ("इञ्जिनियर", "engineer"),
    ("वकिल", "wakil"),
    ...
    # Feelings, breathing, natural expressions
    ("हाहाहा", "haahaaahaa"),
    ("हिहिही", "hihihihi"),
    ("ओहो", "oho"),
    ("अरे", "are"),
    ...
    ("उफ्फ", "uph"),
    ("हैट", "hait"),
    ("मन खुशी छ", "man khushi chha"),
    ("मन दुखेको छ", "man dukheko chha"),
    ("रिस उठ्यो", "ris uthyo"),
    ("डर लाग्यो", "dara laagyo"),
    ("अचम्म पर्यो", "achamma paryo"),
    ("लाज लाग्यो", "laaj laagyo"),
    ("गर्व लाग्यो", "garwa laagyo"),
    ("खुशीले भरिएको छु", "khushile bharieko chhu"),
    ("दुखले भरिएको छु", "dukhle bharieko chhu"),
    ("शान्त महसुस छ", "shaanta mahasoos chha"),
    ("थकित महसुस छ", "thakit mahasoos chha"),
    ("उत्साहित छु", "utsaahit chhu"),
    ("निराश छु", "niraash chhu"),
    ("आशावादी छु", "aashaawaadi chhu"),
]
